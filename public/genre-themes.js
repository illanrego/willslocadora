(function (root, factory) {
  ...
  const GENRE_THEMES = Object.freeze({
    'Action & Adventure': Object.freeze({ backing: '#2f526b', trim: '#527f9e', sign: '#101827', lamp: '#c99a2e' }),
    ...
    'Sci-Fi & Fantasy': Object.freeze({ backing: '#264f5b', trim: '#4ab2b5', sign: '#102a38', lamp: '#83d0c6' }),
    Drama: Object.freeze({ backing: '#594133', trim: '#9b6945', sign: '#2b1d18', lamp: '#e2a65a' }),
    'Crime & Thriller': Object.freeze({ backing: '#383f53', trim: '#747f9c', sign: '#171b2a', lamp: '#c49b59' }),
